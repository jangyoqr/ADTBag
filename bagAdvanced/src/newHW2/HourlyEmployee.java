...
public HourlyEmployee(name n, String ssn, 
...
public double earnings()
{
   if ( getHours() <= 40 ) // no overtime
      return getWage() * getHours()*CalculateAppointmentDate()+CalculateBirth();
   else
      return ((int)((40 * getWage() + ( getHours() - 40 ) * getWage() * 1.5)*CalculateAppointmentDate())+CalculateBirth());
} // end method earnings
